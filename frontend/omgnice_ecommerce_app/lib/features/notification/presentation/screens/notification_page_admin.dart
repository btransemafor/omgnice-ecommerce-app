...
class NotificationsPageAdmin extends StatefulWidget {
  const NotificationsPageAdmin({Key? key}) : super(key: key);

  @override
  _NotificationsPageState createState() => _NotificationsPageState();
}

class _NotificationsPageState extends State<NotificationsPageAdmin> {
  @override
  void initState() {
    super.initState();
    ...
    //  final userProvider = Provider.of<UserProvider>(context, listen: false);
      ...
      notificationProvider.fetchNotifications(isAdmin: true);
    });
  }

  void _markAllAsRead() {
    Provider.of<NotificationProvider>(context, listen: false).markAllAdminNotificationsAsRead();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const NotificationListWidget(isAdmin: true,),
